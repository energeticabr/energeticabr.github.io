...
export const ENTITIES = Object.freeze([
  ...
  entity({ id: "registros-mensais", moduleId: "rh-obras", title: "Registros mensais", listNames: ["REGISTROMENSAL"], available: false }),
  ...
  entity({ id: "associacoes-de-aluguel", moduleId: "patrimonio-locacoes", title: "Associações de aluguel", listNames: ["ASSOCIACAOALUGUEL"], available: false }),
  ...
  entity({ id: "produtos-de-aluguel", moduleId: "patrimonio-locacoes", title: "Produtos de aluguel", listNames: ["PRODUTOALUGUEL"], available: false }),
  ...
  entity({ id: "tarefas-de-aluguel", moduleId: "patrimonio-locacoes", title: "Tarefas de aluguel", listNames: ["TAREFASALUGUEL"], available: false }),
