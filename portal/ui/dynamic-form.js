  ...
  const formHeading = mode === "create" && entity?.id === "notas-pendentes"
    ...
    : mode === "create" && entity?.id === "provisoes-de-pagamento"
      ...
      : mode === "create" && entity?.id === "despesas-recorrentes"
        ...
        : mode === "create" && entity?.id === "produtos"
          ? "Cadastro Produto Form1_5"
        : mode === "create" && entity?.id === "unidades-de-medida"
          ? "Cadastro Unidade de Medida Form1_4"
        : mode === "create" && entity?.id === "contas"
          ? "Cadastro Conta Form52_1"
        : mode === "create" && entity?.id === "fornecedores"
          ? "Cadastro Fornecedor Form2"
        : mode === "create" && entity?.id === "filiais"
          ? "Cadastro Filial Form3"
        : mode === "create" && entity?.id === "lancamentos-de-tarefas"
          ? "Nova Tarefa FORM.TAREFA"
      : mode === "create" && entity?.id === "tarefas-delegadas"
