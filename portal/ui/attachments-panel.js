...
export function createAttachmentPreviewController({ files = [], actions, urlApi = globalThis.URL } = {}) {
  ...
  async function open(index) {
    ...
    const url = urlApi.createObjectURL(bytes instanceof Blob ? bytes : new Blob([bytes], { type }));
    revoke();
