...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorLocalNotifications", path: "../../../node_modules/.pnpm/@capacitor+local-notifications@8.0.1_@capacitor+core@8.5.1/node_modules/@capacitor/local-notifications"),
